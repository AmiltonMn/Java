...
public class ListaEmpregados
{
    ...
    void add(Empregado empregado) // Função de adicionar empregado
    {
        size++;
        NoEmpregados node = new NoEmpregados(empregado); // Cria um novo nó
        ...
        NoEmpregados atual = head; // O funcionário atual recebe o valor da Head
    ...
    Empregado getEmpregados(int index) // Retorna um funcionário
    {
        NoEmpregados atual = head; // O atual é igual a head
        ...
        return atual.getEmpregado(); // Retorna o atual
    }
